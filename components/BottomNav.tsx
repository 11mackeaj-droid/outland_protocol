      ...
      <div className="mx-auto grid max-w-md grid-cols-4 gap-2">
        {tabs.map((tab) => (
          <button
            ...
            className={`min-h-14 rounded-xl px-2 py-2 text-xs font-semibold ${
              activeTab === tab.id
        ...
        <button
          onClick={onOpenSurvivors}
          className="min-h-14 rounded-xl bg-zinc-900 px-2 py-2 text-xs font-semibold text-zinc-300"
        >
          <span className="block text-lg leading-none">●</span>
          <span className="mt-1 block">People</span>
        </button>
